        ...
        for sensor_name in sensors:
            if sensor_name in results:
                ...
                row = {
                    ...
                    "Spray_Pattern": event.get("spray_pattern") or "",
            ...
            [
                {
                    ...
                    "Shower_Head": e.get("shower_head", "Standard"),
                    "Spray_Pattern": e.get("spray_pattern") or "",
                    "Mannequin": e.get("mannequin", False),
            ...
            events.append(
                {
                    ...
                    "spray_pattern": row.get("spray_pattern") or None,
