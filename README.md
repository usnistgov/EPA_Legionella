...
│   └── export_event_timeseries.py    # Export per-event predicted Ct and E_t to Excel (--event N)
│
...
8. **Export Event Time Series** *(optional utility)*: Export per-step predicted Ct and E_t for a single event to Excel:
   ```bash
   ...
   | `--output PATH` | Output Excel file path (default: `output/event_N_timeseries.xlsx`) |
...
**Format:** `MMDD_TempCode_DoorPos_TimeOfDay_RNN`

| Component | Description | Values |
|-----------|-------------|--------|
| `MMDD` | Month and day of the event | e.g., `0115` for January 15 |
| `TempCode` | Water temperature code | `W48`, `W11`, `W25`, `W30`, `W37`, `W23` (°C) |
...
**Examples:**
- `0115_W48_Open_Day_R01` - January 15, 48 °C water, door open, daytime, replicate 1
- `0123_W11_Open_Night_R03` - January 23, 11 °C water, door open, nighttime, replicate 3

**Test Parameter Timeline:**
- W48 (48 °C): From experiment start (2026-01-15)
...
- W23 (23 °C): Starting 2026-02-11 08:00
